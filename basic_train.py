...
def Pseudo_train(cfg: Config, model, train_dl, loss_func, optimizer, save_path, scheduler, writer, tune=None):
...
def Pseudo_train_SoftMatch_HPAv23(cfg: Config, model, train_dl, loss_func, optimizer, save_path, scheduler, writer, tune=None):
...
def Pseudo_train_BiBlabel_SoftMatch(cfg: Config, model, train_dl, loss_func, optimizer, save_path, scheduler, writer, tune=None):
    print(f'[ ! ] pos weight: {cfg.loss.pos_weight}')  # 1
    print(f'[ ! ] cell weight: {cfg.loss.cellweight}')  # 0.1
    print(f'[ ! ] img weight: {cfg.loss.imgweight}')  # 1
    pos_weight = torch.ones(19).cuda() * cfg.loss.pos_weight
